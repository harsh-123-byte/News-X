...
import com.cscorner.newsx.databinding.FragmentHeadlinesBinding
...
class HeadlinesFragment : Fragment(R.layout.fragment_headlines) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val inflator=requireContext().getSystemService(LAYOUT_INFLATER_SERVICE) as LayoutInflater
    ...
    // Pagination---->It helps you Load and Display small chunks of data at a Time.
